  ...
  ToursCompanion toCompanion(bool nullToAbsent) {
    return ToursCompanion(
      ...
      onlineId: onlineId == null && nullToAbsent
          ? const Value.absent()
          : Value(onlineId),
      searchId: searchId == null && nullToAbsent
          ? const Value.absent()
          : Value(searchId),
      name: name == null && nullToAbsent ? const Value.absent() : Value(name),
      author:
              ...
              $mrjc(
                  ...
                  $mrjc(
                      ...
                      $mrjc(difficulty.hashCode,
                          $mrjc(lastEdit.hashCode, desc.hashCode))))))));
  @override
  bool operator ==(dynamic other) =>
      identical(this, other) ||
      (other is Tour &&
...
class $ToursTable extends Tours with TableInfo<$ToursTable, Tour> {
  ...
  GeneratedTextColumn _searchId;
  @override
  GeneratedTextColumn get searchId => _searchId ??= _constructSearchId();
  GeneratedTextColumn _constructSearchId() {
    return GeneratedTextColumn(
      'search_id',
      $tableName,
      false,
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, onlineId, searchId, name, author, difficulty, lastEdit, desc];
  @override
...
class TourStop extends DataClass implements Insertable<TourStop> {
  ...
  TourStopsCompanion toCompanion(bool nullToAbsent) {
...
class TourStopsCompanion extends UpdateCompanion<TourStop> {
  ...
  @override
  String toString() {
    return (StringBuffer('TourStopsCompanion(')
          ..write('id: $id, ')
          ..write('id_tour: $id_tour, ')
          ..write('id_stop: $id_stop')
          ..write(')'))
...
class Extra extends DataClass implements Insertable<Extra> {
  ...
  ExtrasCompanion toCompanion(bool nullToAbsent) {
...
class StopFeature extends DataClass implements Insertable<StopFeature> {
  ...
  StopFeaturesCompanion toCompanion(bool nullToAbsent) {
...
class StopFeaturesCompanion extends UpdateCompanion<StopFeature> {
  ...
  @override
  String toString() {
    return (StringBuffer('StopFeaturesCompanion(')
          ..write('id: $id, ')
          ..write('id_tour: $id_tour, ')
          ..write('id_stop: $id_stop, ')
          ..write('showImages: $showImages, ')
